...
3. Load the script, like ```<script src="//cdnjs.cloudflare.com/ajax/libs/rimg/1.0.0/rimg.min.js"></script>```. You can put it before the ```</body>``` or before the ```</head>``` tag.
...
<script src="//cdnjs.cloudflare.com/ajax/libs/rimg/1.0.0/rimg.min.js"></script>
</head>
<body>
