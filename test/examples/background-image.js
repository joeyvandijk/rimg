casper.test.begin('Background-image test', 55, function suite(test) {
    ...
    casper.then(function() {
        ...
        casper.checkImage(test, 321, 480, 'small', 'background');
        casper.checkImage(test, 479, 480, 'small', 'background');
        casper.checkImage(test, 480, 480, 'small', 'background');
        casper.checkImage(test, 481, 480, 'medium', 'background');
        casper.checkImage(test, 599, 480, 'medium', 'background');
        casper.checkImage(test, 600, 480, 'medium', 'background');
        casper.checkImage(test, 601, 480, 'regular', 'background');
        casper.checkImage(test, 767, 600, 'regular', 'background');
        casper.checkImage(test, 768, 600, 'regular', 'background');
        casper.checkImage(test, 769, 600, 'large', 'background');
        casper.checkImage(test, 1023, 768, 'large', 'background');
        casper.checkImage(test, 1024, 768, 'large', 'background');
        casper.checkImage(test, 1025, 768, 'huge', 'background');
        casper.checkImage(test, 1199, 768, 'huge', 'background');
