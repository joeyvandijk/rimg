casper.test.begin('Manual test', 55, function suite(test) {
    ...
    casper.then(function(){
        ...
        casper.checkImage(test,321,480,'small','manual');
        casper.checkImage(test,479,480,'small','manual');
        casper.checkImage(test,480,480,'small','manual');
        casper.checkImage(test,481,480,'medium','manual');
        casper.checkImage(test,599,480,'medium','manual');
        casper.checkImage(test,600,480,'medium','manual');
        casper.checkImage(test,601,480,'regular','manual');
        casper.checkImage(test,767,600,'regular','manual');
        casper.checkImage(test,768,600,'regular','manual');
        casper.checkImage(test,769,600,'large','manual');
        casper.checkImage(test,1023,768,'large','manual');
        casper.checkImage(test,1024,768,'large','manual');
        casper.checkImage(test,1025,768,'huge','manual');
        casper.checkImage(test,1199,768,'huge','manual');
